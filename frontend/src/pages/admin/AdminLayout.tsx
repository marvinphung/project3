    ...
    <div className="min-h-screen bg-[#F7F8FA] flex">
      ...
      <aside className="hidden lg:flex flex-col w-56 bg-white border-r border-[#E5E7EB] fixed top-0 bottom-0 left-0 z-30">
        ...
        <div className="p-3 border-t border-[#E5E7EB]">
          <button onClick={logout} className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[#6B7280] hover:bg-[#F3F4F6] hover:text-[#111827] transition-colors">
            Đăng xuất
          </button>
